  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-light justify-content-center">
        ...
        <div id="nav-principal" class="collapse navbar-collapse">
          ...
          >
            ...
            <a href="PreguntasFrecuentes.php" class="nav-link"
    ...
    <section>
      ...
      <div class="container productos mt-4">
        <h2 class="text-center">DELEITATE CON NUESTROS RICOS ALMUERZOS</h2>
        <div class="row mt-4 justify-content-center">
          <?php
            include('CRUD/conexion.php');
            $conexion = conexion();
            $consulta = "select * from producto p, almuerzo a where p.id_producto = a.id_almuerzo;";
          ...
          ?>
              <div class="col-md-6 col-lg-4 mb-4 mb-md-4">
                ...
                <div class="info-producto bg-primary text-center text-light">
                  ...
                  <a href="detalles.php?id=<?php echo $fila['id_producto']?>" class="btn btn-success mb-2 btn-lg text-uppercase font-weight-bold">Ver Detalles</a>
                </div>
              </div>
          <?php } 
          $conexion->close();
...
<!--<button class="btn btn-primary">-</button>&nbsp;
    ...
    <footer class="pie-pagina">
      ...
      <div class="grupo-2">
        <small
          >&copy; 2022 <b>EQUIPO INF-281</b> - Todos los Derechos
          Reservados.</small
        >
      </div>
    </footer>
