  ...
  <body>
    ...
    <section>
      ...
      <div class="container productos mt-4">
        <h2 class="text-center">SABOREA LOS PLATILLOS QUE OFRECE NUESTRO </h2>
        <h2 class="text-center">RESTAURANT</h2>
        <div class="row mt-4 justify-content-center">
            <div class="col-md-6 col-lg-4 mb-4 mb-md-4">
                <img src="img/salchipapa.jpg" class="img-fluid img-productos" />
                <div class="info-producto bg-primary text-center text-light">
                  <h3 class="text-center mb-2">SALCHIPAPA</h3>
                  <p class="recio font-weight-bold">25 Bs</p>
                  <a
                    href=""
