  ...
  <body>
    ...
    <section>
      ...
      <div class="container productos mt-4">
        <h2 class="text-center">DISFRUTA DE NUESTROS RICOS POSTRES</h2>
        <div class="row mt-4 justify-content-center">
            <div class="col-md-6 col-lg-4 mb-4 mb-md-4">
                <img src="img/bananasplit.jpg" class="img-fluid img-productos" />
                <div class="info-producto bg-primary text-center text-light">
                  <h3 class="text-center mb-2">BANANA SPLIT</h3>
                  <p class="recio font-weight-bold">38 Bs</p>
                  <a
                    href=""
